...
{
    uint8_t VEGA_RED = lcd.color332(0xEE, 0x17, 0x1B);
    uint8_t VEGA_GRN = lcd.color332(0x22, 0xC8, 0x17);
    uint8_t VEGA_GRY = lcd.color332(0xA4, 0xAF, 0xA8);
    uint8_t VEGA_ORG = lcd.color332(0xFF, 0xA1, 0x23);
    ...
    while(1)
    {
        ...
        lcd.fillRect(  20, 168, 180,  52, VEGA_GRY);        // Communication area

        lcd.setFont(&fonts::Font2);
        lcd.drawString("HBT", 210, 168);
        lcd.drawString("SEN", 210, 186);
        lcd.drawString("LED", 210, 204);
